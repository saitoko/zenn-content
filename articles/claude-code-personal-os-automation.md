...
emoji: "🗂"
type: "idea"
topics: ["claudecode", "ai", "gtd", "productivity", "automation"]
published: false
---
<!-- from: writer | to: - | status: ready -->

毎朝、筆者が最初にやることは「AIに出社指示を出す」ことです。

といっても Slack に「おはよう」と書くわけではありません。Claude Code のターミナルを開いて `/todo dashboard` を打ち込む。それだけで今日のタスクが整理され、secretary エージェントが昨日の続きを引き継いでいる。

この記事では、Claude Code を使って**タスク管理・リサーチ・発信・健康管理の4軸**を統合した個人知的生産システムの全体像を紹介します。「AI組織の設計論」や「1日の体験記」は既に書きましたが、今回の軸は違います。**4軸がどう連携し、人間がどこに意思決定を集中させているか** — CEOの視点から書きます。
